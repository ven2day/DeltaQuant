...
**Main NSE runtime:** `uv run deltaquant-nse`  
...
Configuration can be checked without launching the loop using `uv run python scripts/check_config.py`. The canonical NSE entry point is `uv run deltaquant-nse`; `scripts/run_live_trading.py` is a compatibility launcher only.
...
The configured NSE universe is `config/nse/symbols.csv`. The loader finds a
case-insensitive `symbol` column, trims and uppercases each value, removes blanks, and
...
|---|---|---|
| Settings | `env/.env.common` + active market profile | Warnings and safe degradation |
...
- Configuration: `env/.env.common`, `env/.env.nse`, and their tracked examples
- Main NSE orchestration: `src/markets/nse/runtime/live.py`
- Universe: `src/markets/nse/universe/discovery.py`
- Quote routing/simulation: `src/markets/nse/market_data/manager.py`, `src/markets/nse/market_data/simulated.py`, `src/markets/nse/broker/dhan/quotes.py`, `src/markets/nse/broker/dhan/websocket.py`
- History/indicators/signals: `src/markets/nse/market_data/history_manager.py`, `src/core/indicators/engine.py`, `src/core/candidates/signals.py`
- Ranking: `src/markets/nse/strategies/signal_ranking.py`
...
- Sizing: `src/markets/nse/risk/sizing.py`
- Execution: `src/markets/nse/execution/service.py`, `src/markets/nse/execution/paper_engine.py`, `src/markets/nse/execution/live_executor.py`, `src/markets/nse/execution/adapter.py`, `src/markets/nse/execution/costs.py`
- Exits/journals: `src/markets/nse/execution/exit_manager.py`, `src/markets/nse/execution/journal.py`, `src/markets/nse/execution/signal_log.py`
