...
here does not by itself approve a trade. It only reaches execution after strategy eligibility
admission and every risk_compliance check pass independently (see
and deterministic risk -- this module has no path to bypass either.
"""
