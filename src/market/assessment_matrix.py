...
H-8 and every risk_compliance check before it can become a real trade.
"""
...
from .signal_consolidation import ConsolidatedSignal
...
def _assess_one_timeframe(
    ...
    *,
    ...
    if not compatible:
        score *= 0.5  # penalized, not zeroed -- descriptive label, not a gate
    ...
    # scripts/run_live_trading.py's swing scan, which drops SELL signals before they
